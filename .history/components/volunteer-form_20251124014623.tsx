            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder={t('fullNamePlaceholder')} {...field} className="h-11" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder={t('mobilePlaceholder')} {...field} className="h-11" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder={t('facebookPlaceholder')} {...field} className="h-11" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder={t('twitterPlaceholder')} {...field} className="h-11" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder={t('instagramPlaceholder')} {...field} className="h-11" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
        ...
        return (
          ...
          >
            <FormField
              ...
              render={() => (
                <FormItem>
                  <FormLabel className="text-base font-bold mb-3">{t('volunteerTypes')}</FormLabel>
          ...
          >
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="space-y-3">
                  <FormLabel className="text-base font-bold">{t('hasOrganization')}</FormLabel>
                  <FormControl>
                    <RadioGroup
            ...
            {form.watch('hasOrganization') && (
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-base">{t('organizationName')}</FormLabel>
                    <FormControl>
                      <Input placeholder={t('organizationPlaceholder')} {...field} className="h-11" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
    ...
    <div className="w-full max-w-2xl mx-auto">
      ...
      <div className="mb-8">
        <div className="flex justify-between items-center mb-2">
          ...
          <span className="text-sm font-medium text-gray-600 dark:text-gray-300">{getStepTitle()}</span>
        </div>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="flex justify-between pt-6">
            <Button
              ...
              className="gap-2 bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white"
            >
            ...
            {currentStep < TOTAL_STEPS ? (
              <Button type="button" onClick={nextStep} disabled={isSubmitting} className="gap-2 bg-gradient-to-r from-green-600 to-red-600 text-white hover:from-green-700 hover:to-red-700">
                {t('next')}
              ...
              <Button
                ...
                className="gap-2 bg-gradient-to-r from-green-600 to-red-600 text-white hover:from-green-700 hover:to-red-700"
              >
                {isSubmitting ? (
                  <>
